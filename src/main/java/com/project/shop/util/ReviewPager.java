	...
	public ReviewPager() {
	   ...
	   public void makeRow() {
		  ...
		  public void makePage() {
		     ...
		     //2. 전체 페이지의 갯수
		     long totalPage = this.getTotalCount()/5; //112
		     if(this.getTotalCount()%5 != 0) {
		        totalPage++;
		     }
		   ...
		   //******setter, getter******
			/*
			 * public String getKind() { if(kind == null) { kind = "tt"; } return kind; }
			 * 
			 * public void setKind(String kind) { this.kind = kind; }
			 * 
			 * public String getSearch() { if(search == null) { search = ""; } return
			 * search; }
			 * 
