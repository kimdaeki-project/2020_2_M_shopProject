	...
	<table>
		<tr>
					...
					<td><input type="text"
						...
						id="takePerson" value="${dto.takePerson}"></td>
				</tr>
				<tr>
					...
					<td><input type="text"
						style="width: 300px; height: 40px; margin-left: 50px; margin-top: 10px;"
						id="takePhone" value="${dto.takePhone}"></td>
				</tr>
				<tr>
					...
					<td><input type="text" id="takeAddr1"
						...
						name="orderAddr2"  value="${dto.takeAddr1}">
						<button
				...
				<tr>
					...
					<td><input type="text" id="takeAddr2"
						...
						name="orderAddr2"  value="${dto.takeAddr2}"></td>
				</tr>
				<tr>
					<td class="infotitle"><span></span></td>
					<td><input type="text" id="takeAddr3"
						style="width: 630px; height: 40px; margin-left: 50px; margin-top: 10px;"  value="${dto.takeAddr3}">
					</td>
				</tr>
	</table>
	</div>
	<div class="btnwrap">
		<button class="writebtn" id="write">배송지수정</button>
		<button class="writebtn" id="cancel" style="margin-left: 10px;" >취소</button>
	</div>
